...
Cada vez que recibe una entrada en forma de la palabra Espatifilo, grita involuntariamente a la consola la siguiente cadena: 
...
if palabra == "ESPATIFILIO":
    ...
    print(f'¡ESPATIFILIO!, ¡No {palabra}!')
